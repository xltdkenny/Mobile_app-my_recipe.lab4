                    ...
                    Column(
                        ...
                        Row(
                            ...
                            Box(
                                ...
                                Image(
                                    painter = painterResource(id = R.drawable.zametka_izbr), // Замените на нужное изображение
                                    contentDescription = null,
                                    modifier = Modifier
                                        .size(48.dp) // Размер изображения
                                        .align(Alignment.TopEnd) // Размещение в правом верхнем углу
                                        .padding(8.dp) // Отступ от границ
                                )
                                Column(
                                    modifier = Modifier
                                        .fillMaxWidth()
